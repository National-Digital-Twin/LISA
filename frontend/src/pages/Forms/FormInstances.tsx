      ...
      <Box display="flex" flexDirection="column" gap={2}>
        ...
        {forms?.map((form) => (
          <Box
            ...
            sx={(theme) => ({
              backgroundColor:
                highlightedFormId === form.id ? `${theme.palette.primary.main}20` : 'transparent',
              border:
                highlightedFormId === form.id ? `1px solid ${theme.palette.primary.main}` : 'none',
              borderRadius: 2,
          ...
          >
            ...
            <Box
              ...
              padding={2}
            >
              {(form.formData as { fieldId: string; label: string; value: string }[]).map(
                (field) => (
